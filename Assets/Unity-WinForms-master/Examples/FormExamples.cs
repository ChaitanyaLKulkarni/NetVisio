namespace UnityWinForms.Examples
{
    ...
    public sealed class FormExamples : Form
    {
        ...
        private BaseExamplePanel currentPanel1;
        ...
        public void SetPanel(BaseExamplePanel panel)
        {
            ...
            UnityEngine.Debug.Log(Location.X + " + " + Location.Y);
        ...
        public void SetPanel1(BaseExamplePanel panel)
        {
            if (currentPanel1 != null && currentPanel1.IsDisposed == false)
                currentPanel1.Dispose();

            currentPanel1 = panel;
            currentPanel1.Anchor = AnchorStyles.Left | AnchorStyles.Top | AnchorStyles.Right | AnchorStyles.Bottom;
            currentPanel1.Location = new Point(treeView.Location.X + treeView.Width, uwfHeaderHeight);
            UnityEngine.Debug.Log(Location.X + " + " + Location.Y);
            currentPanel1.Height = Height - uwfHeaderHeight - 16; // We don't want to hide SizeGripRenderer with scrollbars.
            currentPanel1.Width = Width - treeView.Width;
